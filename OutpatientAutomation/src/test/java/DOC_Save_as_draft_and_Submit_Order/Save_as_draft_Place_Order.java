...
public class Save_as_draft_Place_Order {
...
//			By select_Procedures_section = By.xpath(
...
//			driver.findElement(select_Procedures_section).click();
//
//			Thread.sleep(1000);
//
//			By search_Procedures_Order = By.xpath("//*[@id=\"asdfasdf\"]");
//			driver.findElement(search_Procedures_Order)
//					.sendKeys("Diagnostic catheter for intestinal artery" + Keys.ENTER);
//
//			Thread.sleep(1000);
//
...
//			driver.findElement(Select_Procedures_order).click();
			...
			Logger.getLogger(Save_as_draft_Place_Order.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}