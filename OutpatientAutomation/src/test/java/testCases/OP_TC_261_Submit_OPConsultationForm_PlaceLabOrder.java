...
public class OP_TC_261_Submit_OPConsultationForm_PlaceLabOrder extends HP_Test_Base

{
	...
	public void OPConsultationForm() {
		...
		try {
			...
			Logger.getLogger(OP_TC_261_Submit_OPConsultationForm_PlaceLabOrder.class.getName()).log(Level.SEVERE, null, ex);
        }
