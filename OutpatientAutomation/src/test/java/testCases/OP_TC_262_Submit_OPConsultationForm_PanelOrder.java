...
public class OP_TC_262_Submit_OPConsultationForm_PanelOrder extends HP_Test_Base

{
	...
	public void OPConsultationForm() {
		...
		try {
			...
			Logger.getLogger(OP_TC_262_Submit_OPConsultationForm_PanelOrder.class.getName()).log(Level.SEVERE, null, ex);
        }
		...
		form.consultaion_place_panel_order();
