...
public class OP_TC_124_NUR_Filter_Patient_By_Facility extends HP_Test_Base

{
	...
	@Test
	public void Nurse_Filter_Patient_ByFacility() throws InterruptedException {
		...
		type = new NUR_Filter_Patient_list (driver);
		 ...
		 type.Nurse_filter_patientlist_By_Facility();
