...
public class UITestCases {
	...
	private void initialize() {
		...
		final JRadioButton rdbtnNewRadioButton_30 = new JRadioButton("Nurse Newborn Registration for Inpatient form UI");
		...
		final JRadioButton rdbtnNewRadioButton_43 = new JRadioButton("Doctor Submit after save as draft Progress Notes");
		...
		final JRadioButton rdbtnNewRadioButton_47 = new JRadioButton("Doctor Submit after save as draft Operation Note");
		...
		final JRadioButton rdbtnNewRadioButton_52 = new JRadioButton("Doctor Submit after save as draft Discharge Summary");
		...
		final JRadioButton rdbtnNewRadioButton_62 = new JRadioButton("Pharmacist Verify Transfer Stock Across Facilities");
		...
		final JRadioButton rdbtnNewRadioButton_67 = new JRadioButton("Pharmacist Dispense Medication Verification Step");
		...
		final JRadioButton rdbtnNewRadioButton_70 = new JRadioButton("Pharmacist View Stock Availability of Medications");
		...
		final JRadioButton rdbtnNewRadioButton_78 = new JRadioButton("Nurse Register New Born to Admitted Mother");
