...
public class OP_TC_241_Submit_OPConsultationForm_Referral extends HP_Test_Base

{
	...
	public void OPConsultationForm_Medications() {
		...
		try {
			...
			Logger.getLogger(OP_TC_241_Submit_OPConsultationForm_Referral.class.getName()).log(Level.SEVERE, null, ex);
        }
