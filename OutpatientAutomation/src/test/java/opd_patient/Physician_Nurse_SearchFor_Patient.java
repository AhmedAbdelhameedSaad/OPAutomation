...
public class Physician_Nurse_SearchFor_Patient extends Page_Base {
	
	public Physician_Nurse_SearchFor_Patient(WebDriver driver) {
		super(driver); 
	...
	public void search_by_Name(String First_Name)  
	{
		try { 
	  	...
	  	By patient_name_btn =  By.xpath("/html/body/app-root/app-crm/div/div/app-crm-leads/div[2]/div/div[2]/div[2]/div/app-crm-leads-list/div[2]/div[1]/div/div[1]/div[1]/div[1]/p");
			...
			Logger.getLogger(Physician_Nurse_SearchFor_Patient.class.getName()).log(Level.SEVERE, null, ex);
			
		}
	}
	
		
		public void search_by_Name_first_doctor(String First_Name) 
		{
			try { 
				Thread.sleep(4000);  
				By find_patient_btn = By.xpath(
