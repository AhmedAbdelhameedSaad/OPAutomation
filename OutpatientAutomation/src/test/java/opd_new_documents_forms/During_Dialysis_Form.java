...
public class During_Dialysis_Form extends Page_Base {
	...
	public void nurse_fill_during_dialysis_form() {
		...
		try {
			...
			By diagnosis_textbox = By
					.xpath("/html/body/app-root/app-crm/div/div/app-patient-view/app-crm-forms-list/app-activity-modal/div[1]/div[2]/div/div[2]/div[2]/app-clinicalform/div/div[2]/div[1]/div[2]/div/div/div/div/div[2]/app-section/div/div/app-text/div/div[2]/input");
			driver.findElement(diagnosis_textbox).sendKeys("mild case");
			
			By month_checkbox = By
					.xpath("/html/body/app-root/app-crm/div/div/app-patient-view/app-crm-forms-list/app-activity-modal/div[1]/div[2]/div/div[2]/div[2]/app-clinicalform/div/div[2]/div[1]/div[2]/div/div/div/div/div[3]/app-section/div/div/app-check/div/div/div[2]/div[2]/div/input");
			driver.findElement(month_checkbox).click();

			By weight_txtbox = By
					.xpath("/html/body/app-root/app-crm/div/div/app-patient-view/app-crm-forms-list/app-activity-modal/div[1]/div[2]/div/div[2]/div[2]/app-clinicalform/div/div[2]/div[1]/div[2]/div/div/div/div/div[4]/app-section/div/div/app-numericinteger/div/input");
			driver.findElement(weight_txtbox).sendKeys("60");
			
			JavascriptExecutor jse = (JavascriptExecutor)driver;
			 jse.executeScript("arguments[0].scrollTop = arguments[1];",driver.findElement(By.xpath("/html/body/app-root/app-crm/div/div/app-patient-view/app-crm-forms-list/app-activity-modal/div[1]/div[2]/div/div[2]/div[2]/app-clinicalform/div/div[2]/div[1]/div[2]/div/div/div")), 300);
			
			Thread.sleep(3000);
			By sessions_number = By
					.xpath("/html/body/app-root/app-crm/div/div/app-patient-view/app-crm-forms-list/app-activity-modal/div[1]/div[2]/div/div[2]/div[2]/app-clinicalform/div/div[2]/div[1]/div[2]/div/div/div/div/div[5]/app-section/div/div/app-numericinteger/div/input");
			driver.findElement(sessions_number).sendKeys("5");
			
			Thread.sleep(2000);
			
			By duration_txt = By
					.xpath("/html/body/app-root/app-crm/div/div/app-patient-view/app-crm-forms-list/app-activity-modal/div[1]/div[2]/div/div[2]/div[2]/app-clinicalform/div/div[2]/div[1]/div[2]/div/div/div/div/div[6]/app-section/div/div/app-numericinteger/div/input");
		...
		By secondHour = By
			...
			Logger.getLogger(During_Dialysis_Form.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
