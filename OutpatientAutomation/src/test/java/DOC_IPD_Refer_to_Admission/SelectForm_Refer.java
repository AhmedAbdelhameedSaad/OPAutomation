...
public class SelectForm_Refer {
	public void select_form(WebDriver driver) {
		...
		try {
			...
			driver.findElement(searchFormText).sendKeys("OP Hospitals Consultation" + Keys.ENTER);
			...
			Logger.getLogger(SelectForm_Refer.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}
