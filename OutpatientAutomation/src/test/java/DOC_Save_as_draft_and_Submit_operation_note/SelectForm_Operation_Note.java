package DOC_Save_as_draft_and_Submit_operation_note;
...
public class SelectForm_Operation_Note {
	public void select_form(WebDriver driver) {
		...
		try {
			...
			driver.findElement(searchFormText).sendKeys("Operation Note" + Keys.ENTER);
			...
			Logger.getLogger(SelectForm_Operation_Note.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}
