...
public class OP_consultation_form {

	public void Physicians_consultation_Edge(WebDriver driver) {
		...
		try {
			...
			Logger.getLogger(OP_consultation_form.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}