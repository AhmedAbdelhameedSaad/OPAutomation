...
public class Prescribe_Medications {
	...
	public void Physicians_Prescribe_Medications_Edge(WebDriver driver) {
		...
		try {
			...
			By select_Route = By
					.xpath("//*[@id=\"200-00730#0#PRESROUTE\"]/div/div/app-segment/div/div/div[2]/div[1]/div/input");
			driver.findElement(select_Route).click();

			Thread.sleep(3000);

			By select_Frequency = By
					.xpath("//*[@id=\"200-00730#0#PRESFRQ\"]/div/div/app-segment/div/div/div[2]/div[1]/div/input");
			driver.findElement(select_Frequency).click();

			By select_Duration = By
					.xpath("//*[@id=\"200-00730#0#\"]/div/div/app-composite-field/div/div[2]/span[3]/input");
